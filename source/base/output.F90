...
!           write(6,291) "Empty            :",100.0d0*stg(6)/stg(11),'%,',stg(6)/dble(scr_freq*nprocs),"seconds/step"
!           write(6,291) "Empty            :",100.0d0*stg(7)/stg(11),'%,',stg(7)/dble(scr_freq*nprocs),"seconds/step"
